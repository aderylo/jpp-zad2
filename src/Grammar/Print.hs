...
instance Print (Grammar.Abs.Stmt' a) where
  prt i = \case
    ...
    Grammar.Abs.Cont _ -> prPrec i 0 (concatD [doc (showString "continue")])
    Grammar.Abs.Break _ -> prPrec i 0 (concatD [doc (showString "break")])
...
instance Print (Grammar.Abs.ArrType' a) where
  prt i = \case
    Grammar.Abs.Array _ type_ -> prPrec i 0 (concatD [prt 0 type_, doc (showString "["), doc (showString "]")])
