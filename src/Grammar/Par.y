...
Stmt
  ...
  | 'continue' { (uncurry Grammar.Abs.BNFC'Position (tokenLineCol $1), Grammar.Abs.Cont (uncurry Grammar.Abs.BNFC'Position (tokenLineCol $1))) }
...
ArrType :: { (Grammar.Abs.BNFC'Position, Grammar.Abs.ArrType) }
ArrType
